...
extern CC_C pExpr DO_ADD(pExpr E1, pExpr E2);
...
extern CC_C void ASSIGN(pSym S, pExpr Val);
...
extern CC_C MMBOOL SAME_VREF(pExpr V1, pExpr V2);
...
extern CC_C MMBOOL  IS_SIMPLE(pExpr E);
...
extern CC_C pExpr DERIV(pExpr E, pExpr V);
...
extern CC_C pExpr DOT(pExpr E1, pExpr E2);
extern CC_C int NiceDTOC(scalar r, char* Out);
extern CC_C pExpr DO_DVD(pExpr N, pExpr D);
...
extern CC_C pExpr EVAL(pExpr E);
...
extern CC_C void FIXUP_VREFS(pExpr E, pSym S, long NewCnt);
extern CC_C pExpr INDX(pExpr E, tIndex I);
extern CC_C pExpr INDX11(pExpr E, tIndex I, tIndex J);
extern CC_C pExpr INDX12(pExpr E, tIndex I, tIndex J, tIndex K);
extern CC_C pExpr INDX2(pExpr E, tIndex Row, tIndex Col);
...
extern CC_C void SINDX(pExpr E, tIndex I, pExpr Val);
extern CC_C void SINDX2(pExpr E, tIndex I, tIndex J, pExpr Val);
...
extern CC_C pExpr AND(pExpr E1, pExpr E2);
extern CC_C pExpr OR(pExpr E1, pExpr E2);
extern CC_C pExpr NOT(pExpr E1);
extern CC_C pExpr EQUAL(pExpr E1, pExpr E2);
extern CC_C pExpr NOTEQUAL(pExpr E1, pExpr E2);
extern CC_C pExpr LESSTHAN(pExpr E1, pExpr E2);
extern CC_C pExpr GREATERTHAN(pExpr E1, pExpr E2);
extern CC_C pExpr LESSOREQ(pExpr E1, pExpr E2);
extern CC_C pExpr GREATEROREQ(pExpr E1, pExpr E2);
extern CC_C pExpr NEARTO(pExpr E1, pExpr E2, double howClose);
extern CC_C pExpr QUES(pExpr E1, pExpr E2, pExpr E3);
extern CC_C pExpr QUESDVD(pExpr E1, pExpr E2, pExpr E3, pExpr E4);
...
extern CC_C pExpr MATMUL(pExpr M1, pExpr M2);
extern CC_C pExpr DO_MUL(pExpr E1, pExpr E2);
extern CC_C pExpr MUL(pExpr E1, pExpr E2);
extern CC_C pExpr NEG(pExpr E);
extern CC_C enum tExprOrder ORDER(pExpr E, pExpr F);
extern CC_C int strcmp_ci(char* s1, char* s2);
extern CC_C pExpr OUTER(pExpr E1, pExpr E2);
...
extern CC_C void  PRINT_VREF(FILE* F, pExpr V);
...
extern CC_C void  SHOW_TYPE(pExpr E);
...
extern CC_C pExpr DO_SUB(pExpr E1, pExpr E2);
extern CC_C pExpr SUB(pExpr E1, pExpr E2);
extern CC_C pExpr TILDA(pExpr V);
extern CC_C pExpr TRANSPOSE(pExpr E);
extern CC_C void  SCALAR_TYPE(struct tExprType* T);
extern CC_C void  VECTOR_TYPE(NodeValueType_t baseType, struct tExprType* T);
extern CC_C void  MATRIX_TYPE(NodeValueType_t baseType, struct tExprType* T);
extern CC_C void  ARRAY1d_TYPE(NodeValueType_t baseType, tIndex dim1, struct tExprType* T);
extern CC_C void  ARRAY2d_TYPE(NodeValueType_t baseType, tIndex dim1, tIndex dim2, struct tExprType* T);
extern CC_C pExpr USEXIF(pExpr X, pExpr VX);
extern CC_C pExpr VAL(pSym V);
extern CC_C pExpr VAL1(pSym V, tIndex I);
extern CC_C pExpr VAL2(pSym V, tIndex I, tIndex J);
extern CC_C pExpr VREF(pSym V);
extern CC_C pExpr VREF1(pSym V, tIndex Index);
extern CC_C pExpr VREF2(pSym V, tIndex Row, tIndex Col);
...
extern CC_C pExpr APPLYBIN_OP(tBinaryOperator Op, pExpr E1, pExpr E2);
